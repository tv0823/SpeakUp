...
public class Recording {
     ...
     */
    public Recording(String userId, String questionId, String displayTitle, Date dateRecorded, int score, Map<String, String> aiFeedBack) {
        this.userId = userId;
     ...
     *
     * @return A map containing feedback categories and messages.
     */
